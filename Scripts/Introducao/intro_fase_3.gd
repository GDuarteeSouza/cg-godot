...
var steps = [
	{
		"sender": "Eduardo",
		"text": "Eduardo: Isso! Finalmente mandei o trabalho, deu tempo!",
		"bg": Color(0.0, 0.3, 0.6), # Azul
		"is_thought": false
	},
	{
		"sender": "Eduardo",
		"text": "Eduardo: Nossa, que sono absurdo... Preciso correr pra não perder o ônibus...",
		"bg": Color(0.0, 0.0, 0.0), # Tela escura
		"is_thought": true
	},
	{
		"sender": "Eduardo",
		"text": "Eduardo: O quê?! Eu dormi andando?! Meu Deus, preciso correr pro ônibus agora!",
		"bg": Color(0.0, 0.3, 0.6), # Volta pro azul
		"is_thought": false
	}
]
