...
var steps = [
	{
		"sender": "Eduardo",
		"text": "Eduardo: Graças a Deus voltei a tempo!",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": true
	},
	{
		"sender": "Professor D.",
		"text": "Professor D.: Matéria finalizada. Agora é chamada e voltar pra casa! Vamos lá...",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": false
	},
	{
		"sender": "Professor D.",
		"text": "Professor D.: Andreza... é acho que faltou",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": false
	},
	{
		"sender": "Professor D.",
		"text": "Professor D.: André... André veio? Faltou também...",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": false
	},
	{
		"sender": "Professor D.",
		"text": "Professor D.: Bernar...",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": false
	},
	{
		"sender": "Eduardo",
		"text": "Eduardo: Professor, só tem eu aqui...",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": true
	},
	{
		"sender": "Professor D.",
		"text": "Professor D.: Verdade, Eduardo! Aluno empenhado! Presença dada. Não esquece de mandar o trabalho pelo SIGAA, heim. O prazo termina em... 3 minutos. Até semestre que vem!",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": false
	},
	{
		"sender": "Eduardo",
		"text": "Eduardo: ESQUECI DO TRABALHO!!!",
		"bg": Color(0.08, 0.1, 0.2),
		"is_thought": false
	}
]
